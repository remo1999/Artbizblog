...
<hr>
<div class="card">
  <img src="images\easel2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Field Easel">
   <input type="hidden" name="price" value="4000">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="India">
      <input type="hidden" name="pmedium" value="Easel">
       <input type="hidden" name="psurface" value="plastic">
        <input type="hidden" name="orientation" value="Horizontal">
         ...
         <input type="hidden" name="dimension" value="35inches">
  <h2>Field Easel</h2>
 <h2> <p class="price"><b>&#8377;</b>4000</p></h2>
  <p><b>Type	:</b> Handmade</p>
  <p><b>Country of Origin:</b> India</p>
  
  <p><b>Medium	: </b>Easel</p>
  <p><b>Surface	:</b> plastic</p>
  <p><b>Orientation:</b> Horizontal</p>
  <p><b>Size	: </b>medium</p>
  <p><b>Dimension (Inches): </b>35inches</p>
 <br><br><br>
