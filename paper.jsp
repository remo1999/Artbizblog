...
<br>
<div class="content">
  <h2 class="text_shadows">PAPER PAINTING</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\paperpainting1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dpaper1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>30000</div>
                <h3 class="title"><a href="dpaper1.jsp">Forest Joy</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\paperpainting2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dpaper2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>45000 <span><b>&#8377;</b>580000.11</span></div>
                <h3 class="title"><a href="dpaper2.jsp">Sleepy Town</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\paperpainting3.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dpaper3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>38000 <span><b>&#8377;</b>49000</span></div>
                <h3 class="title"><a href="dpaper3.jsp">Blossom</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\paperpainting4.jpg"  > 	
                </a>
                <ul class="product-links">
                    <li><a href="dpaper4.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>39000<span><b>&#8377;</b>50000</span></div>
                <h3 class="title"><a href="dpaper4.jsp">Endless Journey</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
