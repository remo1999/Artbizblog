...
<hr>
<div class="card">
  <img src="images\bandwpainting2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
    <input type="hidden" name="pname" value="City of Dreams">
   <input type="hidden" name="price" value="45000.99">
    <input type="hidden" name="ptype" value="Black and White Painting">
 ...
 <h2> <p class="price"><b>&#8377;</b>45000.99</p></h2>
  <p><b>Type	:</b> Black and White Painting</p>
...
<br><br><br>
  ...
  <p><button class="btn" input type="submit" name="b2" value="Buy Now" formaction="./insertproduct" method="get">Buy Now</button></p>
