...
<hr>
<div class="card">
  <img src="images\stilllife4.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Balance of Life">
   <input type="hidden" name="price" value="40000">
    <input type="hidden" name="ptype" value="Abstract Painting">
      ...
      <input type="hidden" name="pmedium" value="Acrylic">
       <input type="hidden" name="psurface" value="Canvas">
        <input type="hidden" name="orientation" value="Vertical">
         ...
         <input type="hidden" name="dimension" value="29'' X 29''">
  <h2>Balance of Life</h2>
 <h2> <p class="price"><b>&#8377;</b>40000</p></h2>
  <p><b>Type	:</b> Abstract Painting</p>
  ...
  <p><b>Size	: </b>Medium</p>
  <p><b>Dimension (Inches): </b>29'' X 29''</p>
  <br><br><br>
