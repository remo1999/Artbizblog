...
<br>
<div class="content">
  <h2 class="text_shadows">HUMAN PAINTING</h2>
</div>
<br>
<!-- Page content -->
<h2>Human paintings are a form of art that depict the features of the human body.</h2>
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\human1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dhuman1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>80000</div>
                <h3 class="title"><a href="dhuman1.jsp">Expressions</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\human2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dhuman2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>25000.99 <span><b>&#8377;</b>50000.11</span></div>
                <h3 class="title"><a href="dhuman2.jsp">Deep Thoughts</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
