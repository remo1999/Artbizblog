...
.typing-demo {
  width: 22ch;
  animation: typing 5s steps(20), blink .5s step-end infinite alternate;
  white-space: nowrap;
  overflow: hidden;
...
<br>
<div class="content">
  <h2 class="text_shadows">WATERCOLOR PAINTING</h2>
</div>
<br>
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\waterpainting1.jpg" >
                </a>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>26000</div>
                <h3 class="title"><a href="#">Childhood Memories</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\waterpainting2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>22000.99 <span><b>&#8377;</b>30000.11</span></div>
                <h3 class="title"><a href="#">Entrance to Happiness</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\waterpainting3.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>21000.00 <span><b>&#8377;</b>30000.00</span></div>
                <h3 class="title"><a href="#">City Skyline</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\waterpainting4.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="#">Hill Station</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
