...
<hr>
<div class="card">
  <img src="images\bookmark2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Quote Bookmark set">
  ...
  <h2>Quote Bookmark set</h2>
 <h2> <p class="price"><b>&#8377;</b>150</p></h2>
