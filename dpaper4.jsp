...
<hr>
<div class="card">
  <img src="images\paperpainting4.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Expressions">
   <input type="hidden" name="price" value="34500">
    <input type="hidden" name="ptype" value="Human Painting">
 ...
 <h2> <p class="price"><b>&#8377;</b>34500</p></h2>
  <p><b>Type	:</b> Paper Painting</p>
  ...
  <p><b>Size	: </b>Medium</p>
  <p><b>Dimension (Inches): </b>25'' X 27''</p>
  <br><br><br>
