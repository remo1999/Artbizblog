...
<div class="card">
  <img src="images\bookmark1.jpg" alt="PAINTING" style="width:100% ;height:550px">
<form>
  <input type="hidden" name="pname" value="Floral Bookmark Set">
   <input type="hidden" name="price" value="200">
    <input type="hidden" name="ptype" value="Handmade Painting">
      ...
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="paper">
        <input type="hidden" name="orientation" value="Horizontal">
         ...
         <input type="hidden" name="dimension" value="5'' X 5''">
   
 <h2>Floral Bookmark Set </h2>
 <h2> <p class="price"><b>&#8377;</b>200</p></h2>
  <p><b>Type	:</b> Handmade Painting</p>
  <p><b>Country of Origin:</b> India</p>
  <p><b>Medium	: </b>Watercolor</p>
  <p><b>Surface	:</b> paper</p>
  <p><b>Orientation:</b> Horizontal</p>
  <p><b>Size	: </b>small</p>
  <p><b>Dimension (Inches): </b>5'' X 5''</p>
  <br><br><br>
