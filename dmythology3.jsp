...
<hr>
<div class="card">
  <img src="images\Mythology3.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Sun and Moon">
   <input type="hidden" name="price" value="15000">
    <input type="hidden" name="ptype" value="Mythology Painting">
      ...
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="Paper">
        <input type="hidden" name="orientation" value="Horizontal">
         ...
         <input type="hidden" name="dimension" value="15'' X 15''">
  <h2>Sun and Moon</h2>
 <h2> <p class="price"><b>&#8377;</b>15000</p></h2>
  <p><b>Type	:</b> Mythology Painting</p>
  ...
  <p><b>Size	: </b>small</p>
  <p><b>Dimension (Inches): </b>15'' X 15''</p>
  <br><br><br>
