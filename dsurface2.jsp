...
<hr>
<div class="card">
  <img src="images\surface2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="canvas">
   <input type="hidden" name="price" value="700">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="India">
      <input type="hidden" name="pmedium" value="cloth">
