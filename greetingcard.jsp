...
<br>
<div class="content">
  <h2 class="text_shadows">GREETINGCARD</h2>
</div>
<br>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\card1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dgreeting1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>250</div>
                <h3 class="title"><a href="dgreeting1.jsp">festival greeting card</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\card2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dgreeting1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
