...
PreparedStatement s = connection.prepareStatement("select * from productdetails where pname=? and quantity=? ");
s.setString(1,pname);
s.setInt(2,quantity);
...
%>
      ...
      <br>
      <h2 style="margin-left:150px;"><b>Product Name :</b><span style="margin-left:690px;" ><%=resultSet.getString("pname") %></span></h2>
       <h2 style="margin-left:150px;"><b>Quantity :</b><span style="margin-left:690px;" ><%=resultSet.getString("quantity") %></span></h2>
   
      <h2 style="margin-left:150px;"><b>Order Total: <span style="margin-left:680px;" ><%=resultSet.getLong("price") %></span></b></h2>
      <% 
      int price=resultSet.getInt("price");
      session.setAttribute("fee", price);
      }
} catch (Exception e) {
e.printStackTrace();
}%>
      ...
      <br>
      <br>
   <center>   <button type='submit' id="clear-cart"  formaction="payment.jsp" method="get" class="button">Confirm</button></center>
