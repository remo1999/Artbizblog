...
<br>
<div class="content">
  <h2 class="text_shadows">BRUCHES</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\brushes1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dbruches1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>850</div>
                <h3 class="title"><a href="dbruches1.jsp">Watercolor Brushes</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\brushes2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dbruches2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>2000.99 <span><b>&#8377;</b>3000.11</span></div>
                <h3 class="title"><a href="dbruches2.jsp">Palette knifes</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\brushes3.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dbruches3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>1000.00 <span><b>&#8377;</b>1500.00</span></div>
                <h3 class="title"><a href="dbruches3.jsp">Acrylics Brushes</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
