...
<hr>
<div class="card">
  <img src="images\Mythology2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Baby Krishna">
      ...
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="Canvas">
        <input type="hidden" name="orientation" value="Vertical">
         ...
         <input type="hidden" name="dimension" value="35'' X 45''">
  <h2>Baby Krishna </h2>
 <h2> <p class="price"><b>&#8377;</b>15000</p></h2>
  ...
  <p><b>Size	: </b>Large</p>
  <p><b>Dimension (Inches): </b>35'' X 45''</p>
 <br><br><br>
