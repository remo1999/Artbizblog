...
<hr>
<div class="card">
  <img src="images\abstractpainting1.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
 ...
 <h2> <p class="price"><b>&#8377;</b>28000</p></h2>
 ...
 <br><br><br>
  ...
  <option selected hidden value="">Qty</option>
   ...
   <p><button class="btn" input type="submit" name="b2" value="Buy Now" formaction="./Buynow">Buy Now</button></p>
