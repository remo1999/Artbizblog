...
<hr>
<div class="card">
  <img src="images\brushes3.jpg" alt="PAINTING" style="width:100% ;height:550px">
<form>
  <input type="hidden" name="pname" value="Acrylics Brushes">
   <input type="hidden" name="price" value="1000">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="China">
      <input type="hidden" name="pmedium" value="Brucshes">
       <input type="hidden" name="psurface" value="Plastic">
        <input type="hidden" name="orientation" value="no">
         ...
         <input type="hidden" name="dimension" value="5inches">
  <h2>Acrylics Brushes</h2>
 <h2> <p class="price"><b>&#8377;</b>1000</p></h2>
  <p><b>Type	:</b> Handmade </p>
  <p><b>Country of Origin:</b>	China</p>
  
  <p><b>Medium	: </b>Brucshes</p>
  ...
  <option selected hidden value="">Qty</option>
   ...
   <p><button class="btn" input type="submit" name="b2" value="Buy Now" formaction="Buynow.jsp">Buy Now</button></p>
