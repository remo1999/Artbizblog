...
<br>
<div class="content">
  <h2 class="text_shadows">STILL LIFE PAINTING</h2>
</div>
<br>
<!-- Page content -->
<h2>A still life is a drawing or painting that focuses on still objects.</h2>
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\stilllife1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dstilllife.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>30000</div>
                <h3 class="title"><a href="dstilllife.jsp">Blooming Flowers</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\stilllife2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dstilllife2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>44000 <span><b>&#8377;</b>530000</span></div>
                <h3 class="title"><a href="dstilllife2.jsp">Fruit</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\stilllife3.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="stillife3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>35000.00 <span><b>&#8377;</b>49000.00</span></div>
                <h3 class="title"><a href="stillife3.jsp">Thakar Ornament</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\stilllife4.jpg"  > 	
                </a>
                <ul class="product-links">
                    <li><a href="stillife4.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>40000.00 <span><b>&#8377;</b>50000.00</span></div>
                <h3 class="title"><a href="stillife4.jsp">Balance of Life</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
