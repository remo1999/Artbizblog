...
<br>
<div class="content">
  <h2 class="text_shadows"> PAINTS</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\paints1.jpg" >
                </a>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>2000</div>
                <h3 class="title"><a href="#">Watercolor Paints</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\paints2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>2000 <span><b>&#8377;</b>3000.11</span></div>
                <h3 class="title"><a href="#">Acrylics Paints</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
