...
<hr>
<div class="card">
  <img src="images\card2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="festivals greeting card">
