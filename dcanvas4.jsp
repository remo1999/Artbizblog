...
<hr>
<div class="card">
  <img src="images\canvaspainting4.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Raindrops on Lily">
   <input type="hidden" name="price" value="39000">
    <input type="hidden" name="ptype" value="Canvas Painting">
      ...
      <input type="hidden" name="pmedium" value="Acrylic">
       <input type="hidden" name="psurface" value="Canvas">
        <input type="hidden" name="orientation" value=" Vertical">
         ...
         <input type="hidden" name="dimension" value="26'' X 27''">
  <h2>Raindrops on Lily</h2>
 <h2> <p class="price"><b>&#8377;</b>39000</p></h2>
  <p><b>Type	:</b> Canvas Painting</p>
  ...
  <p><b>Size	: </b>Medium</p>
  <p><b>Dimension (Inches): </b>26'' X 27''</p>
<br><br><br>
