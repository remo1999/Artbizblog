...
<br>
<div class="content">
  <h2 class="text_shadows">LIGHT COLOUR PAINTING</h2>
</div>
<br>
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\lightpainting1.jpg" >
                </a>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="#">Greyscale Fovea</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\lightpainting2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="#">Peasants Harvesting White Gold</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\lightpainting3.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="#">White Horse</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
