...
<hr>
<div class="card">
  <img src="images\paperpainting1.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Forest Joy">
   <input type="hidden" name="price" value="30000">
    <input type="hidden" name="ptype" value="Paper Painting">
      ...
      <input type="hidden" name="pmedium" value="Acrylic">
       <input type="hidden" name="psurface" value="Paper">
        <input type="hidden" name="orientation" value="Vertical">
         ...
         <input type="hidden" name="dimension" value="25'' X 27''">
  <h2>Forest Joy</h2>
