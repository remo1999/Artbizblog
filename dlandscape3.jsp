...
<hr>
<div class="card">
  <img src="images\landscape5.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Rocks and Ruins">
   <input type="hidden" name="price" value="40000">
    <input type="hidden" name="ptype" value="landscape Painting">
     <input type="hidden" name="pcountry" value="Algeria">
  ...
  <h2>Rocks and Ruins</h2>
 <h2> <p class="price"><b>&#8377;</b>40000</p></h2>
  <p><b>Type	:</b> landscape Painting</p>
  <p><b>Country of Origin:</b> Algeria</p>
