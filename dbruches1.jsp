...
<hr>
<div class="card">
  <img src="images\brushes1.jpg" alt="PAINTING" style="width:100% ;height:550px">
<form>
  <input type="hidden" name="pname" value="Watercolor Brushes">
   <input type="hidden" name="price" value="850">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="China">
      <input type="hidden" name="pmedium" value="Bruches">
       <input type="hidden" name="psurface" value="metal">
  ...
  <h2>Watercolor Brushes</h2>
 <h2> <p class="price"><b>&#8377;</b>850</p></h2>
  <p><b>Type	:</b> Handmade </p>
  <p><b>Country of Origin:</b>	China</p>
  
  <p><b>Medium	: </b>Bruches</p>
  <p><b>Surface	:</b> metal</p>
  <p><b>Size	: </b>medium</p>
  <br><br>
