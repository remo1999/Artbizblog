...
<br>
<div class="content">
  <h2 class="text_shadows">DARK COLOUR PAINTING</h2>
</div>
<br>
<!-- Page content -->
<<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\darkshades1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="ddark1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>30000</div>
                <h3 class="title"><a href="ddark1.jsp">Moon and Boat in Conversation</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\darkshades2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="ddark2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>45000.99 <span><b>&#8377;</b>580000.11</span></div>
                <h3 class="title"><a href="ddark2.jsp">Marketplace at Night</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\darkshades3.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="ddark3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>38000.00 <span><b>&#8377;</b>49000.00</span></div>
                <h3 class="title"><a href="ddark3.jsp">Portrait of a Dog</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
