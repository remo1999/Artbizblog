...
<hr>
<div class="card">
  <img src="images\lightpainting2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Peasants Harvesting White Gold">
      ...
      <input type="hidden" name="pmedium" value="Acrylic">
       <input type="hidden" name="psurface" value="Canvas">
        <input type="hidden" name="orientation" value="Horizontal">
         ...
         <input type="hidden" name="dimension" value="30'' X 30''">
  <h2>Peasants Harvesting White Gold</h2>
 <h2> <p class="price"><b>&#8377;</b>45000</p></h2>
  ...
  <p><b>Size	: </b>Large</p>
  <p><b>Dimension (Inches): </b>30'' X 30''</p>
 <br><br><br>
