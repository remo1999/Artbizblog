...
<hr>
<div class="card">
  <img src="images\stilllife2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Fruit">
   <input type="hidden" name="price" value="44000">
    <input type="hidden" name="ptype" value="Still life Painting">
      ...
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="Paper">
        <input type="hidden" name="orientation" value="Vertical">
         ...
         <input type="hidden" name="dimension" value="22'' X 22''">
  <h2>Fruit</h2>
 <h2> <p class="price"><b>&#8377;</b>44000</p></h2>
  <p><b>Type	:</b> Still life Painting</p>
  ...
  <p><b>Size	: </b>Medium</p>
  <p><b>Dimension (Inches): </b>22'' X 22''</p>
  <br><br><br>
