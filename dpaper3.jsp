...
<hr>
<div class="card">
  <img src="images\paperpainting3.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Blossom">
      ...
      <input type="hidden" name="pmedium" value="Acrylic">
       <input type="hidden" name="psurface" value="Paper">
        <input type="hidden" name="orientation" value="Horizontal">
         ...
         <input type="hidden" name="dimension" value="18'' X 25''">
  <h2>Blossom</h2>
 <h2> <p class="price"><b>&#8377;</b>38000</p></h2>
  ...
  <p><b>Size	: </b>Medium</p>
  <p><b>Dimension (Inches): </b>18'' X 25''</p>
  <br><br><br>
