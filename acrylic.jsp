...
<br>
<div class="content">
  <h2 class="text_shadows">ACRYLIC PAINTING</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\acrylicpainting1.jpg" >
                </a>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="#">Free Spirited Girl</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\acrylicpainting2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>19000.99 <span><b>&#8377;</b>25000.11</span></div>
                <h3 class="title"><a href="#">Blossoms</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\acrylicpainting3.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>41000.00 <span><b>&#8377;</b>50000.00</span></div>
                <h3 class="title"><a href="#">Burning Candle</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\acrylicpainting4.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa fa-eye"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <div class="price"><b>&#8377;</b>38000.00 <span><b>&#8377;</b>50000.00</span></div>
                <h3 class="title"><a href="#">Serene Evening Mood</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
