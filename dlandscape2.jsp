...
<hr>
<div class="card">
  <img src="images\landscape2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Rajasthan Series">
   <input type="hidden" name="price" value="80000">
    <input type="hidden" name="ptype" value=" landscape Painting">
     <input type="hidden" name="pcountry" value="Afghanistan">
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="Canvas">
        <input type="hidden" name="orientation" value="Vertical">
         <input type="hidden" name="size" value="Medium">
         <input type="hidden" name="dimension" value="35'' X 35''">
   
  <h2>Rajasthan Series</h2>
 <h2> <p class="price"><b>&#8377;</b>15000</p></h2>
  <p><b>Type	:</b> landscape Painting</p>
  <p><b>Country of Origin:</b>Afghanistan</p>
  
  <p><b>Medium	: </b>Acrylic</p>
  <p><b>Surface	:</b> Canvas</p>
  <p><b>Orientation:</b>Vertical</p>
  <p><b>Size	: </b>Medium</p>
  <p><b>Dimension (Inches): </b>35'' X 35''</p>
  <br><br><br>
  ...
  <option selected hidden value="">Qty</option>
   ...
   <p><button class="btn" input type="submit" name="b2" value="Buy Now" formaction="./Buynow" method="get">Buy Now</button></p>
