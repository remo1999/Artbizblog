...
<br>
<div class="content">
  <h2 class="text_shadows">EASEL</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\easel1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="deasel1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>1400</div>
                <h3 class="title"><a href="deasel1.jsp">Metal Easel</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\easel2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="deasel2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>4000 <span><b>&#8377;</b>9999</span></div>
                <h3 class="title"><a href="deasel2.jsp">Field Easel</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
