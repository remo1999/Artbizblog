...
<br>
<div class="content">
  <h2 class="text_shadows">CANVAS PAINTING</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\canvaspainting1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dcanvas1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price">Rs 30000</div>
                <h3 class="title"><a href="dcanvas1.jsp">3 Panel Wall Art</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\canvaspainting2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dcanvas2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>45000.99 <span><b>&#8377;</b>580000.11</span></div>
                <h3 class="title"><a href="dcanvas2.jsp">Challenge</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\canvaspainting3.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dcanvas3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>38000.00 <span><b>&#8377;</b>49000.00</span></div>
                <h3 class="title"><a href="dcanvas3.jsp">Expressions</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\canvaspainting4.jpg"  > 	
                </a>
                <ul class="product-links">
                    <li><a href="dcanvas4.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>39000.00 <span><b>&#8377;</b>50000.00</span></div>
                <h3 class="title"><a href="dcanvas4.jsp">Raindrops on Lily</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
