...
<hr>
<div class="card">
  <img src="images\darkshades1.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Moon and Boat in Conversation">
      ...
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="paper">
        <input type="hidden" name="orientation" value=" Vertical">
         ...
         <input type="hidden" name="dimension" value="36'' X 37''">
   
  <h2>Moon and Boat in Conversation</h2>
 <h2> <p class="price"><b>&#8377;</b>30000</p></h2>
  ...
  <p><b>Size	: </b>Large</p>
  <p><b>Dimension (Inches): </b>36'' X 37''</p>
   <br><br><br>
