...
<hr>
<div class="card">
  <img src="images\darkshades3.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Portrait of a Dog">
   <input type="hidden" name="price" value="10000">
    <input type="hidden" name="ptype" value="Dark Painting">
      ...
      <input type="hidden" name="pmedium" value="Acrylic">
       <input type="hidden" name="psurface" value="paper">
        <input type="hidden" name="orientation" value=" Vertical">
         ...
         <input type="hidden" name="dimension" value="20'' X 20''">
  <h2>Portrait of a Dog</h2>
 <h2> <p class="price"><b>&#8377;</b>10000</p></h2>
  <p><b>Type	:</b> Dark Painting</p>
  ...
  <p><b>Size	: </b>small</p>
  <p><b>Dimension (Inches): </b>20'' X 20''</p>
   <br><br><br>
  ...
  <option selected hidden value="">Qty</option>
   ...
   <p><button class="btn" input type="submit" name="b2" value="Buy Now" formaction="LANDSCAPE" method="get">Buy Now</button></p>
  <p><button class="btn" input type="submit" name="b1" value="Add to Cart">Add to Cart</button></p>
  </form>
</div>
