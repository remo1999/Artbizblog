...
<br>
<div class="content">
  <h2 class="text_shadows">MYTHOLOGY PAINTING</h2>
</div>
<br>
 Traditionally classified as a form of history painting, mythological pictures are based on themes taken from mythology - that is, from traditional tales invented to explain a particular belief, historical event, or fact of nature.
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\Mythology1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dmythology1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>23000</div>
                <h3 class="title"><a href="dmythology1.jsp">Marble Buddha</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\Mythology2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dmythology2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>15000.99 <span><b>&#8377;</b>25000.11</span></div>
                <h3 class="title"><a href="dmythology2.jsp">Baby Krishna </a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\Mythology3.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dmythology3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>150000.00 <span><b>&#8377;</b>200000.00</span></div>
                <h3 class="title"><a href="dmythology3.jsp">Sun and Moon</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
