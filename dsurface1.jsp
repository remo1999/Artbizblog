...
<hr>
<div class="card">
  <img src="images\surface1.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Pastel Paper">
   <input type="hidden" name="price" value="250">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="India">
      <input type="hidden" name="pmedium" value="colorpaper">
       <input type="hidden" name="psurface" value="Paper">
        <input type="hidden" name="orientation" value="small">
         <input type="hidden" name="size" value="Medium">
         <input type="hidden" name="dimension" value="10'' X 10''">
  <h2>Pastel Paper</h2>
 <h2> <p class="price"><b>&#8377;</b>250</p></h2>
  <p><b>Type	:</b> Handmade</p>
  <p><b>Country of Origin:</b> India</p>
  
  <p><b>Medium	: </b>colorpaper</p>
  <p><b>Surface	:</b> paper</p>
  <p><b>Orientation:</b> Horizontal</p>
  <p><b>Size	: </b>small</p>
  <p><b>Dimension (Inches): </b>10'' X 10''</p>
  <br><br><br>
  ...
  <option selected hidden value="">Qty</option>
   ...
   <p><button class="btn" input type="submit" name="b2" value="Buy Now" formaction="Buynowjsp" method="get">Buy Now</button></p>
