...
<hr>
<div class="card">
  <img src="images\paints2.jpg" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Acrylics Paints">
   <input type="hidden" name="price" value="2000">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="China">
      <input type="hidden" name="pmedium" value="Acrylics">
       <input type="hidden" name="psurface" value="Plastic">
        <input type="hidden" name="orientation" value="no">
         <input type="hidden" name="size" value="Medium">
         <input type="hidden" name="dimension" value="25inches">
  <h2>Acrylics Paints</h2>
 <h2> <p class="price"><b>&#8377;</b>2000</p></h2>
  <p><b>Type	:</b> Handmade </p>
  <p><b>Country of Origin:</b>	China</p>
  
  <p><b>Medium	: </b>Acrylics</p>
  <p><b>Surface	:</b> Plastic</p>
  <p><b>Size	: </b>medium</p>
   <br><br><br>
