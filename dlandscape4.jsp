...
<hr>
<div class="card">
  <img src="images\landscape4.JPG" alt="PAINTING" style="width:100% ;height:550px">
  <form>
  <input type="hidden" name="pname" value="Heavenly Downhill">
    ...
    <input type="hidden" name="ptype" value="Landscape Painting">
     <input type="hidden" name="pcountry" value="China">
      <input type="hidden" name="pmedium" value="Watercolor">
       <input type="hidden" name="psurface" value="Paper">
        <input type="hidden" name="orientation" value="Horizontal">
         <input type="hidden" name="size" value="Large">
         <input type="hidden" name="dimension" value="35'' X 30''">
   
  <h2>Heavenly Downhill</h2>
 <h2> <p class="price"><b>&#8377;</b>35000</p></h2>
  <p><b>Type	:</b> Landscape Painting</p>
  <p><b>Country of Origin:</b>	China</p>
  
  <p><b>Medium	: </b>Watercolor</p>
  <p><b>Surface	:</b> Paper</p>
  <p><b>Orientation:</b> Horizontal</p>
  <p><b>Size	: </b>Large</p>
  <p><b>Dimension (Inches): </b>35'' X 30''</p>
  <br><br><br>
