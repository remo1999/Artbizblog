...
<br>
<div class="content">
  <h2 class="text_shadows">BLACK AND WHITE PAINTING</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\bandwpainting1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="bw1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price">Rs 30000</div>
                <h3 class="title"><a href="bw1.jsp">Horizon</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\bandwpainting2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="bw2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>45000.99 <span><b>&#8377;</b>580000.11</span></div>
                <h3 class="title"><a href="bw2.jsp">City of Dreams</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
...
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\bandwpainting3.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="bw3.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price">Rs38000.00 <span>Rs49000.00</span></div>
                <h3 class="title"><a href="bw3.jsp">The Bird</a></h3>
               <ul class="rating"> <center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
