...
<br>
<div class="content">
  <h2 class="text_shadows">SURFACE PAINTING</h2>
</div>
<br>
<!-- Page content -->
<div class="row">
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\surface1.jpg" >
                </a>
                <ul class="product-links">
                    <li><a href="dsurface1.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>250</div>
                <h3 class="title"><a href="dsurface1.jsp">Pastel Paper</a></h3>
    ...
    <div class="col-md-4 col-sm-8">
        <div class="product-grid">
            <div class="product-image">
                <a href="#" class="image">
                    <img class="img-1" src="images\surface2.jpg"  >
                </a>
                <ul class="product-links">
                    <li><a href="dsurface2.jsp"><i class="fa fa-eye"></i></a></li>
                </ul>
            </div>
            <div class="product-content">
                <div class="price"><b>&#8377;</b>700.99 <span><b>&#8377;</b>900.11</span></div>
                <h3 class="title"><a href="dsurface1.jsp">Canvas Board</a></h3>
                <ul class="rating"><center>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
                    <li class="fas fa-star"></li>
