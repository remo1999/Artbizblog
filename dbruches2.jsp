...
<hr>
<div class="card">
  <img src="images\brushes2.jpg" alt="PAINTING" style="width:100% ;height:550px">
<form>
  <input type="hidden" name="pname" value="Palette knifes">
   <input type="hidden" name="price" value="2000">
    <input type="hidden" name="ptype" value="Handmade">
     <input type="hidden" name="pcountry" value="China">
      <input type="hidden" name="pmedium" value="palette">
